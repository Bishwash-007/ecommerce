...
const OAuthButton: React.FC<OAuthButtonProps> = ({
  ...
  return (
    <TouchableOpacity
      ...
      style={style}
      className={`flex-row items-center dark:bg-white justify-center gap-3 px-4 py-3 rounded-3xl border-hairline border-muted-900 dark:border-muted-700 ${className}`}
      {...props}
    >
      <Image
        source={iconSource}
